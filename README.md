...
void man(char *name)
{
    ...
    {
        printf("Description : Used to close all i=opened file\n");
        printf("Usage : closeall\n");
    }
    else if(strcmp(name,"lseek")==0)
    {
        printf("Description : Used to changed file offset\n");
        printf("Usage : lseek File_Name ChangeInOffSet StarttPoint\n");
    }
    ...
    {
        printf("ERROR : No maunal entry available.\n");
    }
}
...
void DisplayHelp()
{
    ...
    printf("read : To read the contennts from file\n");
...
int rm_File(char * name)
{
    ...
    if(UFDTArr[fd].ptrfiletable->ptrinode->LinkCount == 0)
    {
        ...
        //freee(UFDTArr[fd].ptrfiletable->ptrinode->Buffer);
    ...
    while(1)
    {
       ...
       count = sscanf(str,"%s %s %s %s", command[0],command[1],command[2],command[3]);
        ...
        if(count == 1)
        {
            ...
            {
                printf("Teminating the Marvellous Virtual Fie System\n");
                break;
            }
            else
            {
